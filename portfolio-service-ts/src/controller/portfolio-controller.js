...
const dbClient = new ESDB(appConfig.esdbConfig.connection, appConfig.esdbConfig.snapshotTrigger);
...
exports.spinOffSecurity = async (request) => {
  await portfolio.spinOffSecurity(request.portfolioId, request.accountId,
